...
static const struct parameter {
    ...
    void *ptr;
        ...
        { "USE_CYCLIC_BRAKE",         T_BOOL,  0,  1,   0, &eepromBuffer.can.use_cyclic_brake},
        { "CYCLIC_BRAKE_KP",          T_UINT8, 0, 255,  64, &eepromBuffer.can.cyclic_brake_kp},
        { "CYCLIC_BRAKE_KI",          T_UINT8, 0, 255,   8, &eepromBuffer.can.cyclic_brake_ki},
        { "CYCLIC_BRAKE_MAX_DUTY",    T_UINT8, 0, 200, 100, &eepromBuffer.can.cyclic_brake_max_duty},
